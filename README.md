...
提供動画 `OneBe_Process_to_Logo_1920x1080_v2.mp4` を `public/assets/onebe-loading-v2.mp4` として内容を変更せず使用しています（10秒・1920×1080・402,860バイト）。同じタブで最初にサイトを開いたときだけ、無音・インラインで再生し、終了時にサイトへ切り替わります。スキップボタンとEscapeで即座に進めます。画面比率が違っても動画全体が入る表示です。
